        ...
        function ($stateProvider, $urlRouterProvider, $locationProvider, $qProvider) {
            ...
            $stateProvider
                ...
                .state('author', {
                    ...
                    menu: 'Authors' //Matches to name of 'Authors' menu in LibraryAppNavigationProvider
                })
                .state('book', {
                    url: '/book',
                    template: '<book-list></book-list>',
                    menu: 'Books' //Matches to name of 'Books' menu in LibraryAppNavigationProvider
                })
                .state('category', {
                    url: '/category',
                    template: '<category-list></category-list>',
                    menu: 'Categories' //Matches to name of 'Categories' menu in LibraryAppNavigationProvider
                });
        }
    ]);
